...
export class OAuthApi {
     ...
     * @param inlineObject2 
     */
    public async oauthAuthorizePost (inlineObject2: InlineObject2, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2008;  }> {
     ...
     * @param inlineObject1 
     */
    public async oauthTokenPost (inlineObject1: InlineObject1, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2007;  }> {
