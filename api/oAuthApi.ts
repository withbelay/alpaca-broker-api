...
export class OAuthApi {
     ...
     * @param inlineObject3 
     */
    public async oauthAuthorizePost (inlineObject3: InlineObject3, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2009;  }> {
     ...
     * @param inlineObject2 
     */
    public async oauthTokenPost (inlineObject2: InlineObject2, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2008;  }> {
