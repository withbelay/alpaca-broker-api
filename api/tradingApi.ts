...
export class TradingApi {
     ...
     */
    public async closePosition (accountId: string, symbol: string, qty?: string, percentage?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderObject;  }> {
