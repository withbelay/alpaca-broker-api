...
export class CalendarApi {
     ...
     */
    public async calendarGet (start?: string, end?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2001;  }> {
